        ...
        <div className="w-full max-w-5xl px-4 py-20 flex flex-col items-center text-center">
          ...
          >
            ...
            >
              ...
              <span className="text-gray-400 text-sm mt-1">Input Sources</span>
            </motion.div>
            <motion.div
              className="flex flex-col items-center"
              variants={itemVariants}
            >
              <span className="text-4xl font-bold text-blue-400">300</span>
              <span className="text-gray-400 text-sm mt-1">Word Articles</span>
            </motion.div>
            <motion.div
              className="flex flex-col items-center"
              variants={itemVariants}
            >
              ...
              <span className="text-gray-400 text-sm mt-1">Possibilities</span>
            </motion.div>
          </motion.div>
        </div>
      </div>
